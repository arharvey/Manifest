...
//Last modified: Thu, Jan 12, 2012 05:08:54 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.2041583479188773 14.105922889269848 11.406275625663858 ;
	setAttr ".r" -type "double3" -42.938352729608589 48.200000000001353 0 ;
