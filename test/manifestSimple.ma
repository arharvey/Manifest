...
//Last modified: Thu, Jan 12, 2012 05:19:54 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.062731090809315 10.675802488405843 11.985768992909923 ;
	setAttr ".r" -type "double3" -30.938352729608603 53.00000000000145 2.6424686648774942e-15 ;
...
connectAttr "manifestHub1.t[1]" "locator1.t";
...
connectAttr "locator1.msg" "hyperView3.rnd[0]";
connectAttr "locatorShape1.msg" "hyperView3.rnd[1]";
...
connectAttr "locator1.msg" "hyperView3.fnd";
connectAttr "cube.msg" "hyperLayout4.hyp[0].dn";
connectAttr "locator1.msg" "hyperLayout4.hyp[1].dn";
connectAttr ":time1.msg" "hyperLayout4.hyp[2].dn";
connectAttr "locatorShape1.msg" "hyperLayout4.hyp[3].dn";
